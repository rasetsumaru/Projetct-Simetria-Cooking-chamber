...
Public Class FConfigParameters
	...
	Public Sub InitializeForm()
		...
		For index As Integer = 0 To 1
			Dim address As String = "@LabelForms.FConfigParameters.ControlSystem.Label00" + index.ToString()
			cboControl.Items.Add(Localization.GetText(address))
		Next
	
		cboControl.SelectedIndex = System.Convert.ToInt32(AppService.VWGet("Controller.Controller.Application.SETTINGS.Temperature_control_system"))
		Humidity()
		
	End Sub

    Private Sub cboControl_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboControl.SelectedIndexChanged
        
		AppService.VWSet("Controller.Controller.Application.SETTINGS.Temperature_control_system", Convert.ToBoolean(cboControl.SelectedIndex))
		Humidity()
	...
	Private Sub Humidity()
		...
		If AppService.VWGet("Controller.Controller.Application.SETTINGS.Temperature_control_system") = False Then
			...
			VarInUpperHumidity.Visible = True
			VarInLowerHumidity.Visible = True
			
		Else
		
			VarInUpperHumidity.Visible = False
			VarInLowerHumidity.Visible = False
