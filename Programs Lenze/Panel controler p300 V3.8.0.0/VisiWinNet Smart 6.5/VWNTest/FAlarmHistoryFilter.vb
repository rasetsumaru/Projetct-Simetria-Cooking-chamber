...
Public Class FAlarmHistoryFilter
	...
	Public Sub Init()
		If AppService.VWGet("AlarmManagement.AlarmHistory.Filter.Option") < 1 Then
			AppService.VWSet("AlarmManagement.AlarmHistory.Filter.MinTime", 01/01/0001)
			AppService.VWSet("AlarmManagement.AlarmHistory.Filter.MaxTime", AppService.VWGet("__SYSTEM.TIME"))
		End If
		AppService.VWSet("AlarmManagement.AlarmHistory.Filter.Option", 1)
	End Sub

    Private Sub cmdOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOk.Click
        AppService.VWSet("AlarmManagement.AlarmHistory.UpdateListTrigger", 1)
		Me.Close()
		Me.Dispose()
    End Sub
