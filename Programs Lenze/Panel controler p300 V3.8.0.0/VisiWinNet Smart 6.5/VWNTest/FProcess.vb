...
Public Class FProcess
	...
	Public Sub InitializeForm()
		...
		Me.lblStatus.VWItem.Name = "Controller.Controller.Application.GLOBAL.Program_chamber_status<[" + indexChamber.ToString() + "]>"
		
		Me.VarOutProgrammedRecipe.VWItem.name = "Controller.Controller.Application.RECIPES.Recipe_name<[" + indexChamber.ToString() + "]>"
		Me.VarOutRecipeDescription.VWItem.name = "Controller.Controller.Application.RECIPES.Recipe_description<[" + indexChamber.ToString() + "]>"
		Me.VarOutNumberCycles.VWItem.name = "Controller.Controller.Application.RECIPES.Recipe_cycles<[" + indexChamber.ToString() + "]>"
		Me.VarOutNumberSteps.VWItem.name = "Controller.Controller.Application.RECIPES.Recipe_steps<[" + indexChamber.ToString() + "]>"
		Me.VarOutCycles.VWItem.name = "Controller.Controller.Application.GLOBAL.Program_cycles<[" + indexChamber.ToString() + "]>"
		Me.VarOutSteps.VWItem.name = "Controller.Controller.Application.GLOBAL.Program_steps<[" + indexChamber.ToString() + "]>"
		Me.VarOutEstimatedTime.VWItem.Name = "Controller.Controller.Application.GLOBAL.Program_estimated<[" + indexChamber.ToString() + "]>"
		Me.VarOutElapsedTime.VWItem.Name = "Controller.Controller.Application.GLOBAL.Program_elapsed<[" + indexChamber.ToString() + "]>"
		Me.DateTimeOutInitProcess.VWItem.name = "Controller.Controller.Application.GLOBAL.Program_process_init<[" + indexChamber.ToString() + "]>"
		Me.DateTimeOutEstimated.VWItem.Name = "Controller.Controller.Application.GLOBAL.Program_estimated_time<[" + indexChamber.ToString() + "]>"
		
		Dim addressStatus  As String = "Controller.Controller.Application.GLOBAL.Program_chamber_status<[" + indexChamber.ToString() + "]>"
		
		Select Case System.Convert.ToInt32(AppService.VWGet(addressStatus))
			Case Is = 0
				Me.cmdStart.Enabled = True
				Me.cmdPause.Enabled = False
				Me.cmdStop.Enabled = False
				Me.Label003.Visible = False
				Me.Label004.Visible = False
				Me.DateTimeOutInitProcess.Visible = False
				Me.DateTimeOutEstimated.Visible = False
			Case Is = 2
		...
		RearmTimer.Enabled = True
        RearmTimer.Interval = 200
		
	End Sub

    Private Sub cmdStart_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdStart.Click
        
		Dim address  As String = "Controller.Controller.Application.GLOBAL.Program_chamber_status<[" + indexChamber.ToString() + "]>"
			
		Select Case System.Convert.ToInt32(AppService.VWGet(address))

			Case Is = 0
				If FMessageBox.Show(Localization.GetText("@LabelForms.FMessageBox.Captions.Caption002"), _
					Localization.GetText("@LabelForms.FMessageBox.Messages.Message036"), MessageBoxButtons.YesNo) = DialogResult.Yes Then
			
					Me.cmdStart.Enabled = False
					Me.cmdPause.Enabled = True
					Me.cmdStop.Enabled = False
					
					AppService.VWSet("Controller.Controller.Application.GLOBAL.Program_process_init<[" + indexChamber.ToString() + "]>", AppService.VWGet("__SYSTEM.TIME"))
					
					AppService.VWSet(address, 1)
					
					Me.Label003.Visible = True
					Me.Label004.Visible = True
					Me.DateTimeOutInitProcess.Visible = True
					Me.DateTimeOutEstimated.Visible = True
		
				End If
			
			Case Is = 3
				If FMessageBox.Show(Localization.GetText("@LabelForms.FMessageBox.Captions.Caption002"), _
					Localization.GetText("@LabelForms.FMessageBox.Messages.Message040"), MessageBoxButtons.YesNo) = DialogResult.Yes Then
			
					Me.cmdStart.Enabled = False
					Me.cmdPause.Enabled = True
					Me.cmdStop.Enabled = False
		
					AppService.VWSet(address, 9)
    ...
    Private Sub cmdPause_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPause.Click
		...
		If FMessageBox.Show(Localization.GetText("@LabelForms.FMessageBox.Captions.Caption002"), _
			Localization.GetText("@LabelForms.FMessageBox.Messages.Message037"), MessageBoxButtons.YesNo) = DialogResult.Yes Then
		
			If System.Convert.ToInt32(AppService.VWGet(address)) = 2 Then
				AppService.VWSet(address, 3)
				Me.cmdStart.Enabled = True
				Me.cmdPause.Enabled = False
				Me.cmdStop.Enabled = True
			End If 
    ...
    Private Sub cmdStop_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdStop.Click
		...
		If FMessageBox.Show(Localization.GetText("@LabelForms.FMessageBox.Captions.Caption002"), _
			Localization.GetText("@LabelForms.FMessageBox.Messages.Message038"), MessageBoxButtons.YesNo) = DialogResult.Yes Then
			
			If System.Convert.ToInt32(AppService.VWGet(address)) = 3 Then
				AppService.VWSet(address, 6)
				Me.cmdStart.Enabled = False
				Me.cmdPause.Enabled = False
				Me.cmdStop.Enabled = False
			End If 
    ...
    Private Sub RearmTimer_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RearmTimer.Tick
        
		If AppService.VWGet("__FORMS.ACTIVEFORM") = Me.Name Then
			...
			For i As Integer = 0 To chambers
				...
				If value > 3 And value < 7 And indexChamber = i Then
