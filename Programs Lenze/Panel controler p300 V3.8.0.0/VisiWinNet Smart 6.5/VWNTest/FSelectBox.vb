...
Public Class FSelectBox
	...
	Public Overloads Shared Function Show(ByVal label As String) As DialogResult
        Return ShowSelectBox(label)
    End Function
	
	Private Shared Function ShowSelectBox(ByVal label As String) As DialogResult

        Dim frm As New FSelectBox 
	...
	Private Sub SetLabel(ByVal label As String)
        lblLabel.text = label
    End Sub

	Private Sub SetCombo()
		
		For index As Integer = 1 To System.Convert.ToInt32(AppService.VWGet("Controller.Controller.Application.SETTINGS.Enabled_chambers"))
			cboChamber.Items.Add(Localization.GetText("@LabelForms.FSelectBox.Label001") + " 0" + index.ToString())
		Next
    ...
    Private Sub cboChamber_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboChamber.SelectedIndexChanged
        AppService.VWSet("ProcessSystem.ChamberIndex", cboChamber.SelectedIndex)
