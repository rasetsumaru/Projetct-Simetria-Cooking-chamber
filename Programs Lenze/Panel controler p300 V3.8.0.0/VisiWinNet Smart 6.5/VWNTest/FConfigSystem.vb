...
Public Class FConfigSystem
	...
	Public Sub InitializeForm()
		...
		Me.VarInCoreTemperatureOffset.VWItem.name = "Controller.Controller.Application.SETTINGS.Core_temperature_offset<[" + indexChamber.ToString() + "]>"
		Me.VarInChamberTemperatureOffset.VWItem.Name = "Controller.Controller.Application.SETTINGS.Chamber_temperature_offset<[" + indexChamber.ToString() + "]>"
		Me.VarInHumidityOffset.VWItem.Name = "Controller.Controller.Application.SETTINGS.Chamber_humidity_offset<[" + indexChamber.ToString() + "]>"
